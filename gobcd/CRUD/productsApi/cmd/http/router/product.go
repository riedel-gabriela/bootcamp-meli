...
import (
	...
	"github.com/riedel-gabriela/bootcamp-meli/gobcd/CRUD/productsApi/cmd/http/handler"
	"github.com/riedel-gabriela/bootcamp-meli/gobcd/CRUD/productsApi/internal/product"
)
